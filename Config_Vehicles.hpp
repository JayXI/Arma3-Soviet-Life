    ...
    */
    ...
    class cop_car {
        ...
        vehicles[] = {
            { "sab_UN_Car", 5000, { "" }, { "", "", -1 } },
            { "sab_UN_SUV", 20000, { "" }, { "", "", -1 } },
            { "sab_UN_Offroad", 30000, { "" }, { "life_coplevel", "SCALAR", 1 } },
            { "sab_UN_APC", 30000, { "" }, { "life_coplevel", "SCALAR", 3 } }
        };
    };
    ...
    class cop_air {
        side = "cop";
        vehicles[] = {
            { "sab_UN_Heli", 75000, { "cAir" }, { "", "", -1 } },
			{ "sab_UN_Heli_armed", 75000, { "cAir" }, { "", "", -1 } },
            { "sab_UN_Large_Heli", 200000, { "cAir" }, { "life_coplevel", "SCALAR", 3 } }
        };
    };
    ...
    class cop_ship {
        side = "cop";
        vehicles[] = {
            { "sab_UN_Boat_armed", 3000, { "cg" }, { "", "", -1 } },
            { "sab_UN_Boat", 20000, { "cg" }, { "", "", -1 } },
    ...
    class civ_ship {
        ...
        side = "cop";
        vehicles[] = {
            { "B_Quadbike_01_F", 2500, { "" }, { "life_coplevel", "SCALAR", 4 } },
            { "C_Hatchback_01_F", 9500, { "" }, { "life_coplevel", "SCALAR", 4 } },
            { "C_Offroad_01_F", 12500, { "" }, { "life_coplevel", "SCALAR", 4 } },
            { "C_SUV_01_F", 30000, { "" }, { "life_coplevel", "SCALAR", 4 } },
            { "C_Hatchback_01_sport_F", 40000, { "" }, { "life_coplevel", "SCALAR", 4 } },
            { "C_Van_01_transport_F", 45000, { "" }, { "life_coplevel", "SCALAR", 4 } }
		};
	};
        ...
        vehicles[] = {
            { "B_Quadbike_01_F", 2500, { "" }, { "", "", -1 } },
            { "C_Hatchback_01_F", 9500, { "" }, { "", "", -1 } },
            { "C_Offroad_01_F", 12500, { "" }, { "", "", -1 } },
            { "C_SUV_01_F", 30000, { "" }, { "", "", -1 } },
            { "C_Hatchback_01_sport_F", 40000, { "" }, { "", "", -1 } },
            { "C_Van_01_transport_F", 45000, { "" }, { "", "", -1 } }
		};
	};
        ...
        vehicles[] = {
            ...
            { "C_Hatchback_01_sport_F", 40000, { "" }, { "", "", -1 } },
            { "C_Van_01_transport_F", 45000, { "" }, { "", "", -1 } },
			{ "B_Heli_Light_01_F", 289000, { "" }, { "", "", -1 } },
			{ "O_Heli_Light_02_unarmed_F", 350000, { "" }, { "", "", -1 } },
			{ "O_UGV_01_F", 500000, { "" }, { "", "", -1 } },
		};
	};
